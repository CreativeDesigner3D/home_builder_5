...
WALL_OBSTACLES = [
    ('OUTLET_STANDARD', "Standard Outlet", "Standard electrical outlet", 'PLUGIN', 
     units.inch(2.75), units.inch(4.5), units.inch(2), units.inch(12), 'WALL'),
    ('OUTLET_DOUBLE', "Double Outlet", "Double-gang electrical outlet", 'PLUGIN', 
     units.inch(4.5), units.inch(4.5), units.inch(2), units.inch(12), 'WALL'),
    ('OUTLET_GFCI', "GFCI Outlet", "Ground fault circuit interrupter outlet", 'PLUGIN', 
     units.inch(2.75), units.inch(4.5), units.inch(2), units.inch(42), 'WALL'),
    ('SWITCH_SINGLE', "Light Switch", "Single light switch", 'LIGHT', 
     units.inch(2.75), units.inch(4.5), units.inch(2), units.inch(48), 'WALL'),
    ('SWITCH_DOUBLE', "Double Switch", "Double light switch", 'LIGHT', 
     units.inch(4.5), units.inch(4.5), units.inch(2), units.inch(48), 'WALL'),
