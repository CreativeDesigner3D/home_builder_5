...
CATALOG = [
    ...
    _e('standard', 'Appliance Garage',
       'Separate straight appliance garage: wall-cabinet body standing '
       'on the countertop, meeting the upper above.',
       _ff('Appliance Garage'), tags=['wall', 'garage', 'appliance']),
    ...
    _e('corner', 'Diagonal Appliance Garage',
       'Separate diagonal appliance garage standing on the countertop.',
       {'action_operator': 'hb_face_frame.place_corner_cabinet',
        'action_args': {'cabinet_name': 'Diagonal Appliance Garage'}},
       tags=['diagonal', 'garage', 'appliance']),
    _e('corner', 'Pie Cut Appliance Garage',
       'Separate pie-cut appliance garage standing on the countertop; '
       'pairs with bi-fold doors under a blind corner or pie-cut upper.',
       {'action_operator': 'hb_face_frame.place_corner_cabinet',
        'action_args': {'cabinet_name': 'Pie Cut Appliance Garage'}},
       tags=['pie cut', 'garage', 'appliance', 'bi-fold']),
