...
SECTIONS = (
    {
        ...
        'rows': (
            ...
            ("Angled End", (("Base", "Angled End Base", "Angled End Base"),
                            ("Tall", "Angled End Tall", "Angled End Tall"),
                            ("Upper", "Angled End Upper", "Angled End Upper"))),
    ...
    },
    {
        ...
        'rows': (
            ("", (("Fridge Cabinet", "Refrigerator Cabinet",
                  ...
                  ("Column Fridge", "Tall Column Refrigerator",
